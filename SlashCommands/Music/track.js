...
module.exports = {
    name: "track",
    description: "Dengarkan Musik di servermu!",
    ...
    options: [
        {
            name: "clearqueue",
            description: "Menghapus antrean musik dan meninggalkan voice channel!",
            type: "SUB_COMMAND",
        },
        {
            name: "play",
            ...
            options: [
                {
                    name: "song",
                    description: "Lagu untuk dimainkan",
                    type: "STRING",
                    required: true
                }
            ]
        ...
        {
            name: "previoustrack",
            description: "mainkan lagu sebelumnya lagi!",
            type: "SUB_COMMAND"
        },
        {
            name: "info",
            description: "Dapatkan info untuk lagu saat ini atau tertentu dalam antrean!",
            type: "SUB_COMMAND",
            options: [
                {
                    name: "index",
                    description: "Indeks lagu dalam antrean!",
                    type: "NUMBER",
                    required: false,
                }
            ]
        ...
        {
            name: "jump",
            description: "lompat ke lagu tertentu dalam antrean!",
            type: 'SUB_COMMAND',
            options: [
                {
                    name: "index",
                    description: "Memberikan nomor indeks lagu!",
                    type: "NUMBER",
                    required: true,
                }
            ]
        ...
        {
            name: "lyrics",
            description: "Dapatkan lirik untuk sebuah lagu!",
            type: "SUB_COMMAND",
            options: [
                {
                    name: "query",
                    description: "Lagu untuk mendapatkan lirik untuk!",
                    type: "STRING",
                    required: true,
                }
            ]
        ...
        {
            name: "loop",
            description: "Memutar lagu atau seluruh antrean!",
            type: "SUB_COMMAND",
            options: [
                {
                    name: "mode",
                    description: "pilih mode loop baru untuk diubah!",
                    type: 'STRING',
                    required: false,
                    choices: [
                        {
        ...
        {
            name: "move",
            description: "Mengubah posisi lagu dalam antrean!",
            type: "SUB_COMMAND",
            options: [
                {
                    name: "from",
                    description: "Posisi untuk memindahkan lagu dari!",
                    type: "NUMBER",
                    required: true
                },
                {
                    name: "to",
                    description: "Posisi untuk memindahkan lagu ke!",
                    type: 'NUMBER',
                    required: true
                }
            ]
        ...
        {
            name: "queue",
            description: "Memperlihatkan antrean musik untuk server Anda!",
            type: "SUB_COMMAND",
            options: [
                {
                    name: "page",
    ...
    try {
      ...
      .setAuthor("Kobi Musik Box", client.user.displayAvatarURL())
      .setDescription(`👍 Join ${queue.connection.channel.toString()} dan 📄 gabung ke ${queue.metadata.channel.toString()}`)
      ...
      return client.say.errorMessage(interaction, `ga bisa gabung ke voice channel Mu!\n\`${error}\``);
    }
