...
module.exports = {
    name: "userinfo",
    description: "Dapatkan info tentang akun Anda atau akun pengguna yang di mention!",
    aliases: ["ui"],
    run: async (client, message, args) => {
        ...
        var bot = {
            "true": "IYA, Pengguna ini adalah BOT",
            "false": "TIDAK, Pengguna ini murni MANUSIA kok"
        };
